/* ../include/zdk/auto/config.h.  Generated from config.h.in by configure.  */
/* ../include/zdk/auto/config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to 1 if the system has the type `modify_ldt_t'. */
/* #undef HAVE_MODIFY_LDT_T */
...
/* Define to 1 if the system has the type `thread_t'. */
...
/* support for unordered_map detected */
...
/* Define to 1 if the system has the type `__uint32_t'. */
