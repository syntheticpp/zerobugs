...
#define STABS_CONST_BOOL        'b'
#define STABS_CONST_CHAR        'c'
#define STABS_CONST_TYPED_INT   'e'
#define STABS_CONST_INT         'i'
#define STABS_CONST_REAL        'r'
#define STABS_CONST_STRING      's'
#define STABS_CONST_SET         'S'
...
/**
 * See: http://sources.redhat.com/gdb/onlinedocs/stabs.html#Constants
 */
bool
                            ...
                            bool            isStatic)
{
    ...
    // FIXME: I don't know exactly why this happens for
                                  ...
                                  int             token)
{
    ...
    RefPtr<DataType> qualifiedType = current_unit()->get_type(types_, qualifiedID);
